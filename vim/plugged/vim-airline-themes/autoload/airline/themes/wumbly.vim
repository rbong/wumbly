...
let g:airline#themes#jellybeans#palette.normal.airline_warning = s:warning_group
let g:airline#themes#jellybeans#palette.normal.airline_error = s:warning_group
...
let g:airline#themes#jellybeans#palette.insert.airline_warning = s:warning_group
let g:airline#themes#jellybeans#palette.insert.airline_error = s:warning_group
...
let g:airline#themes#jellybeans#palette.visual.airline_warning = s:warning_group
let g:airline#themes#jellybeans#palette.visual.airline_error = s:warning_group
...
let g:airline#themes#jellybeans#palette.replace.airline_warning = s:warning_group
let g:airline#themes#jellybeans#palette.replace.airline_error = s:warning_group
...
let g:airline#themes#jellybeans#palette.inactive.airline_warning = s:warning_group
let g:airline#themes#jellybeans#palette.inactive.airline_error = s:warning_group
